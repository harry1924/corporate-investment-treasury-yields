...
CAPTIONS = {
    ...
    "fin_06_financing_gap_long": "1929 年以来，企业融资缺口与长端名义利率温和正相关，与实际利率的关系不稳定",
    "fin_02_supply_regression": "季度流量数据中，公司债净发行对长端利率的推升效应不可识别",
    "fin_07_corp_issuance_vs_rates": "企业中长期发债多在利率下行期放量，发行择时特征明显",
    "fin_08_treasury_issuance_vs_rates": "附息国债净供给多在衰退与财政扩张期上升，本轮与期限溢价同步上行",
    "fin_09_horizon_correlation": "拉长时间窗口后，净发行与同期利率变化的负相关加深，择时效应主导流量关系",
    "fin_10_stocks_vs_term_premium": "控制通胀后，2007 年前私人持有附息国债越多期限溢价越高；QE 后关系断裂",
    "fin_12_long_net_supply_decomp": "≥10 年国债净供给的分解：发行扩张抬升净供给，美联储购债阶段性对冲",
    "fin_11_long_net_supply_vs_rates": "QE 期间美联储吸收长久期净发行，2022 年后私人净供给维持在 GDP 的 2% 以上",
    "fin_13_long_net_supply_coefs": "扣除美联储后的 ≥10 年国债净供给对 30 年期美债的推升在各窗口均成立，其他口径不稳定",
...
**长端利率的供给压力主要来自国债长久期净供给。** 扣除美联储后的 10 年以上国债私人净供给，3 年窗口内每年多 1 个点 GDP，同期 30 年期美债上行 87.1bp（t=3.84）；含美联储或全部期限口径下均不成立。2022 年以来私人净供给维持在 GDP 的 2% 以上。
...
**企业部门影响美债利率的五条渠道，历史证据强弱不一：** 一是政策利率渠道，投资增速与联邦基金利率变化的相关系数稳定在 0.5—0.7，证据最强；二是名义增长渠道，名义 GDP 增速与 10 年期美债的相关系数为 0.76—0.83；三是外部融资需求渠道，融资缺口与实际利率同向（0.47）；四是久期供给渠道，企业长久期发债的推升效应在季度回归与事件研究中均未识别，量级或在数个 bp 以内，但扣除美联储后的 10 年以上国债私人净供给对长端利率的推升统计上成立（3 年窗口每 1 个点 GDP 对应 30 年期美债 +87bp）；五是避险渠道，信用利差与美债收益率长期负相关，但近年减弱。

**对当前的判断：** AI 资本开支目前集中在知识产权产品与少数现金充裕的发行人，有形投资占比与企业融资缺口两项总量指标均未显示扩张。本轮美债期限溢价上行更多来自国债长久期供给：美联储缩表后，10 年以上国债私人净供给维持在 GDP 的 2% 以上，企业部门的贡献有限。若有形投资/GDP 回升至 9% 以上、融资缺口转正并扩大至 1% GDP 以上，企业部门对美债利率的推升或由“边际”转为“系统性”。
